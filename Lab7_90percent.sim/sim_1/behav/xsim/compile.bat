...
REM
REM Generated by Vivado on Tue Dec 02 16:38:16 -0700 2025
...
echo "xvlog --incr --relax -L uvm -prj sar_fsm_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj sar_fsm_tb_vlog.prj -log xvlog.log
