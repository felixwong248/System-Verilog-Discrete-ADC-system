...
REM
REM Generated by Vivado on Tue Nov 25 14:48:15 -0700 2025
...
echo "xvlog --incr --relax -L uvm -prj ramp_subsystem_sar_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ramp_subsystem_sar_tb_vlog.prj -log xvlog.log
