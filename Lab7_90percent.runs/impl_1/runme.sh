...
HD_PWD='C:/ENEL453_Vivado/Lab7_90percent/Lab7_90percent.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_7_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_7_top_level.tcl -notrace
