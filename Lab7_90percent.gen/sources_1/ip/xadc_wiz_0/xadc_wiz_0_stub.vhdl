...
-- Date        : Tue Nov 11 23:15:25 2025
-- Host        : Felix-Surface-Pro-8 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top xadc_wiz_0 -prefix
--               xadc_wiz_0_ xadc_wiz_0_stub.vhdl
-- Design      : xadc_wiz_0
...
architecture stub of xadc_wiz_0 is
  ...
  attribute black_box_pad_pin of stub : architecture is "daddr_in[6:0],dclk_in,den_in,di_in[15:0],dwe_in,reset_in,vauxp15,vauxn15,busy_out,channel_out[4:0],do_out[15:0],drdy_out,eoc_out,eos_out,alarm_out,vp_in,vn_in";
begin
end;
