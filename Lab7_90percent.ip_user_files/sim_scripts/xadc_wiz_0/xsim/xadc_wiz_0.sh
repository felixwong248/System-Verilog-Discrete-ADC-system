...
#
# Script generated by Vivado on Tue Nov 11 23:14:46 -0700 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : xadc_wiz_0.sh
...
#
# Usage        : xadc_wiz_0.sh
#                xadc_wiz_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xadc_wiz_0.sh [-reset_run]
#                xadc_wiz_0.sh [-reset_log]
#                xadc_wiz_0.sh [-help]
#
...
# script info
echo -e "xadc_wiz_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xadc_wiz_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xadc_wiz_0 xil_defaultlib.xadc_wiz_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xadc_wiz_0 -key {Behavioral:sim_1:Functional:xadc_wiz_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xadc_wiz_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xadc_wiz_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xadc_wiz_0.sh [-help]\n\
Usage: xadc_wiz_0.sh [-step]\n\
Usage: xadc_wiz_0.sh [-lib_map_path]\n\
Usage: xadc_wiz_0.sh [-reset_run]\n\
Usage: xadc_wiz_0.sh [-reset_log]\n\
Usage: xadc_wiz_0.sh [-keep_index]\n\
Usage: xadc_wiz_0.sh [-noclean_files]\n\n\
